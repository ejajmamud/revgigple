...
<!--                                           <button type="submit" wire:loading.attr="disabled" wire:target="login" class="button">Login</button>-->
<!--                                           <div class="line"></div>-->
<!--                                       </div>-->
...
<div>
    ...
    <div class="flex w-full max-w-sm grow flex-col justify-center p-5 " style="display:block">
				...
				<form x-data="window.zyKtAkZuKbBmbfC" x-on:submit.prevent="login" class="grid grid-cols-12 md:gap-x-6 gap-y-6">
					...
					@if (settings('security')->is_recaptcha)
						<div  class="col-span-12 " wire:ignore>
							<div style="width:50% !important" class="g-recaptcha" data-sitekey="{{ config('recaptcha.site_key') }}" data-theme="{{ current_theme() }}"></div>
						</div>
					@endif
...
" type="submit" wire:loading.attr="disabled" wire:target="login" :disabled="!form.email || !form.password" class="button login_btn">LOGIN</button>
                                <div class="line">
                	...
                	<div class="col-span-12 button_area flex-row-reverse"  style="
    margin-right: 10px;
">
...
" type="submit" wire:loading.attr="disabled" wire:target="login" :disabled="!form.email || !form.password" class="button login_btn"> LOGIN
					...
					<div class="col-span-12">
						...
						<!--<button type="submit" wire:loading.attr="disabled" wire:target="login" :disabled="!form.email || !form.password" class="w-full bg-primary-600 enabled:hover:bg-primary-700 text-white py-4.5 px-4 rounded-md text-[13px] font-semibold tracking-wide disabled:bg-zinc-200 disabled:text-zinc-500 dark:disabled:bg-zinc-500 dark:disabled:text-zinc-300 disabled:cursor-not-allowed">-->
						    	...
						    	<button style="display:none !important" class="button"  type="submit" wire:loading.attr="disabled" wire:target="login" :disabled="!form.email || !form.password" class="inline-block text-black bg-sky-500 py-2 px-5 leading-normal font-normal border-b-2 border-r-2 enabled:hover:bg-black  enabled:hover:text-white py-4.5 px-4 rounded-md text-[13px] font-semibold tracking-wide disabled:cursor-not-allowed" style="display: inline-block; font-size: 1.6rem; line-height: 1.2; color: #000; background-color: var(--sky); padding: 0.5rem 1.4rem; letter-spacing: 0.2rem; font-weight: 400; border: none; border-bottom: 0.2rem solid #000 !important; border-right: 0.2rem solid #000 !important;" >
