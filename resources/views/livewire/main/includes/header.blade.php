<style>
    ...
    .dropdown:hover .dropbtn {background-color: #26c0ec;}
</style>


<header style="display:none" class="bg-white dark:bg-[#0f0f0f] shadow-sm w-full z-40 transition-all duration-200">
    <div x-data="window.TTRjRvxLbHzaKxW">
            ...
            <div class="w-full hidden lg:block">
                <div class="relative max-w-md" x-data="{ open: false }">
                    ...
                    @if (count($gigs) || count($sellers) || count($tags) || $q)
                        <div
                            class="absolute top-16 w-full bg-white dark:bg-zinc-800 rounded-lg border border-gray-100 dark:border-zinc-800 shadow-md max-w-full z-[60]"
                                                        ...
                                                        <li class="group flex cursor-default select-none items-center px-4 py-2">
                                                            <a href="{{ url('search?q=' . $tag->name) }}"
                                                               class="flex items-center">
                                                                ...
                                                                <span
                                                                    class="ml-3 flex-auto truncate">{{ $tag->name }}</span>
                                                            </a>
                                                        </li>
                                                    @endif
                                                @endforeach
                    ...
                    @if (auth()->user()->account_type === 'seller')
                        <a href="{{ url('seller/orders') }}"
                           class="text-gray-500 hover:text-primary-600 dark:text-gray-100 dark:hover:text-white transition-colors duration-300 py-2 mx-4 relative hidden md:block">
                            <svg
                                class="text-gray-400 hover:text-gray-700 h-6 w-6 dark:text-gray-100 dark:hover:text-white"
                                stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                @auth
                    <div class="hidden md:inline-block relative ltr:ml-4 rtl:mr-4" x-data="{ open: false }">
                        ...
                        @if (auth()->user()->isOnline() && !auth()->user()->availability)
                            <div
                                class="absolute top-0 ltr:right-0 rtl:left-0 w-3 h-3 rounded-full bg-green-400 border-2 border-white dark:border-transparent"></div>
                        @elseif (auth()->user()->availability)
                            <div
                                class="absolute top-0 ltr:right-0 rtl:left-0 w-3 h-3 rounded-full bg-gray-400 border-2 border-white dark:border-transparent"></div>
                        @else
                            <div
                                class="absolute top-0 ltr:right-0 rtl:left-0 w-3 h-3 rounded-full bg-red-400 border-2 border-white dark:border-transparent"></div>
                        @endif
                        ...
                        @if (auth()->user()->avatar)
                            <img x-on:click="open = !open" src="{{ placeholder_img() }}"
                                 ...
                                 class="lazy inline-block w-8 h-8 rounded-full cursor-pointer object-cover">
                        @else
                            <div x-on:click="open = !open"
                                ...
                                <svg class="hi-solid hi-user inline-block w-4 h-4" fill="currentColor"
                                     viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="py-1.5 px-3.5">
                                ...
                                <a href="{{ url('account/deposit') }}"
                                   class="group flex items-center py-1.5 group-hover:text-primary-600">
                                    ...
                                    <span
                                        class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500">{{ __('messages.t_deposit') }}</span>
                                </a>
                                ...
                                <a href="{{ url('account/reviews') }}"
                                   class="group flex items-center py-1.5 group-hover:text-primary-600">
                                    ...
                                    <span
                                        class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500">{{ __('messages.t_reviews') }}</span>
                                </a>
                                ...
                                <a href="{{ url('account/refunds') }}"
                                   class="group flex items-center py-1.5 group-hover:text-primary-600">
                                    ...
                                    <span
                                        class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500">{{ __('messages.t_refunds') }}</span>
                                </a>
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 hidden md:block">
            ...
            @foreach ($categories as $category)
                @if (count($category->subcategories))
                    <div data-popover role="tooltip" id="popover-subcategories-{{ $category->uid }}"
                           ...
                           x-on:click="open = !open">
                            ...
                            <span x-bind:class="{ 'rotate-90': !open, 'rotate-0': open }"
                                ...
                                <svg fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"
                                     class="hi-solid hi-chevron-down inline-block w-4 h-4"><path fill-rule="evenodd"
                                                                                                 d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                            ...
                            @foreach ($categories as $category)
                                <details class="group ltr:ml-4 rtl:mr-4"
                                    ...
                                    <summary class="flex items-center text-gray-500 dark:text-gray-300 py-2 px-5">
                                        ...
                                        {{-- Category name --}}
                                        <span
                                            class="ltr:ml-3 rtl:mr-3 text-[13px] font-medium"> {{ $category->name }} </span>
                                    ...
                                    <nav class="mt-1.5 ltr:ml-8 rtl:mr-8 flex flex-col">
                                        ...
                                        <a href="{{ url('categories/' . $category->slug) }}"
                                           class="flex items-center px-4 py-2 text-gray-800 dark:text-gray-100 rounded-lg hover:bg-gray-100 dark:hover:bg-zinc-700 hover:text-gray-700 dark:hover:text-gray-200">
                                            <span
                                                class="ltr:ml-3 rtl:mr-3 text-xs font-medium"> {{ __('messages.t_browse_parent_category', ['category' => $category->name]) }} </span>
                                        </a>
                                        ...
                                        @foreach ($category->subcategories as $sub)
                                            <a href="{{ url('categories/' . $category->slug . '/' . $sub->slug) }}"
                                               class="flex items-center px-4 py-2 text-gray-500 dark:text-gray-300 rounded-lg hover:bg-gray-100 hover:text-gray-700">
                                                <span
                                                    class="ltr:ml-3 rtl:mr-3 text-xs font-medium"> {{ $sub->name }} </span>
                                            </a>
                                        @endforeach
                    ...
                    <div x-data="{ open: false }" class="space-y-1">
                        ...
                        <div
                            ...
                            @foreach (supported_languages() as $lang)
                                <div
                                    @if ($default_language_code !== $lang->language_code) wire:click="setLocale('{{ $lang->language_code }}')"
                                    @endif class="py-2 px-5 rounded-sm inline-flex items-center cursor-pointer justify-between {{ $default_language_code === $lang->language_code ? 'bg-primary-100/25 text-primary-600' : 'hover:bg-gray-50 dark:hover:bg-zinc-600' }} focus:outline-none w-full">
                                    <div class="inline-flex items-center">
                                        <img src="{{ placeholder_img() }}"
                                             data-src="{{ countryFlag($lang->country_code) }}" alt="{{ $lang->name }}"
...
<header>
    ...
    {{-- Admin navbar --}}
    @auth('admin')
        <div class="bg-gray-900 dark:bg-primary-600 pb-1">
            <div class="max-w-7xl mx-auto h-10 px-4 flex items-center justify-between sm:px-6 lg:px-8">
            ...
            <div class="col-md-9 col-4">
                ...
                <div class="menu_wrapper">
                    <ul id="menu">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('explore/projects') }}" class="nav-link">Projects</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('giggers') }}" class="nav-link">Giggers</a>
                        </li>
                        
                          <li class="nav-item">
                            <a href="{{ url('generativeai') }}" class="nav-link">AI Jobs</a>
                        </li>
                        
                        
                        <li class="nav-item">
                            <a href="{{ url('business') }}" class="nav-link">Gigple Business</a>
                        </li>
                        ...
                        @auth
                            ...
                            <div class="dropdown" style="display:none">
                                <button class="text-black py-2 px-5 text-base font-medium dropbtn">
                                    {{ auth()->user()->username }}
                                    <i class="fa fa-arrow-right" aria-hidden="true"></i>
                                </button>
                                <div class="dropdown-content">
                                    <a href="{{ url('business/dashshboard') }}">{{ __('messages.t_logged_in_as_username', ['username' => auth()->user()->username]) }}
                                        <br>
                                        <span class="font-semibold dark:text-white">@money(auth()->user()->balance_available, settings('currency')->code, true)</span>
                                    </a>
                                    @if (auth()->user()->account_type === 'seller')
                                    ...
                                    @if (auth()->user()->account_type === 'buyer' || auth()->user()->account_type === 'seller')
                    ...
                    {{-- Sign in --}}
                    @guest
                        <a href="{{ url('auth/login-consultant') }}" class="button2">LOGIN/REGISTER</a>
                    @endguest
