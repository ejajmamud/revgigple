<footer style="display:none;" class="bg-white dark:bg-zinc-800 px-4 sm:px-6 lg:px-60 pt-20 pb-10 lg:pb-20 relative z-10">
...
<footer>
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-sm-4 col-6 mt_30">
                <h2>CATEGORIES</h2>
                <ul>
                    @php
                        $projectCat = App\Models\ProjectCategory::orderBy('name')->get();
                    @endphp

                    @foreach($projectCat as $catItem)
                        <li><a href="{{ url('/explore/projects/'.$catItem->slug) }}">{{ $catItem->name }}</a></li>
                    @endforeach
...
{{--                                2 means legal--}}
                            ...
                            @endforeach
                    @endif
                        <li><a href="{{ url('help/contact') }}">Contact Us</a></li>
            ...
            <div class="col-lg-3 col-sm-4 col-6 mt_30">
                ...
                <ul>
                    ...
                    <li><a href="{{ url('business-gigs') }}">Gigs</a></li>
                    <li><a href="{{ url('giggers') }}">Giggers</a></li>
                    <li><a href="{{ url('business-gigs') }}">Gigple Business</a></li>
                </ul>
            </div>
            ...
            <div class="col-lg-3 ft-last mt_30">
                <a href="{{ url('/') }}"><img src="{{ asset('public/storage/about-us/ft_lst_img.svg') }}" alt="not"></a>
                <div class="ft_icon_section">

                    {{-- Facebook --}}
                    @if (settings('footer')->social_facebook)
                        <a href="{{ settings('footer')->social_facebook }}" target="_blank"><i class="fab fa-facebook-f"></i></a>
                    @endif

                    {{-- Twitter --}}
                    @if (settings('footer')->social_twitter)
                        <a href="{{ settings('footer')->social_twitter }}"><i class="fa-brands fa-twitter"></i></a>
                    @endif

                    {{-- Instagram --}}
                    @if (settings('footer')->social_instagram)
                        <a href="{{ settings('footer')->social_instagram }}"><i class="fab fa-instagram"></i></a>
                    @endif

                    {{-- Pinterest --}}
                    @if (settings('footer')->social_pinterest)
                        <a href="{{ settings('footer')->social_pinterest }}"><i class="fa-brands fa-pinterest"></i></a>
                    @endif

                    {{-- Linkedin --}}
                    @if (settings('footer')->social_linkedin)
                        <a href="{{ settings('footer')->social_linkedin }}"><i class="fab fa-linkedin-in"></i></a>
                    @endif

                    {{-- Github --}}
                    @if (settings('footer')->social_github)
                        <a href="{{ settings('footer')->social_github }}"><i class="fa-brands fa-github"></i></a>
                    @endif

                    {{-- Youtube --}}
                    @if (settings('footer')->social_youtube)
                        <a href="{{ settings('footer')->social_youtube }}"><i class="fa-brands fa-youtube"></i></a>
                    @endif
        ...
        <div class="ft_end_text">
            <p>© 2023 GIGPLE. ALL RIGHTS RESERVED.</p>
        </div>
    </div>
</footer>
<!-- back to top -->
