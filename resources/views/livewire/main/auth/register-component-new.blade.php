...
<!--    <div class="relative w-full shadow-sm rounded-md">-->
<!--        {{-- Input --}}-->
<!--        <input type="file" name="company_logo" class="{{ $errors->first('company_logo') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300' }} border text-gray-900 text-sm rounded-md font-medium block w-full ltr:pr-12 rtl:pl-12 p-4 placeholder:font-normal dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Upload Company Logo">-->
<!--    </div>-->
...
<!--    <div class="relative w-full shadow-sm rounded-md">-->
<!--        {{-- Input --}}-->
<!--        <input type="file" name="ssm_document" class="{{ $errors->first('ssm_document') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300' }} border text-gray-900 text-sm rounded-md font-medium block w-full ltr:pr-12 rtl:pl-12 p-4 placeholder:font-normal dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Upload SSM Document">-->
<!--    </div>-->
...
<!--- tonmoy --->
                    ...
                    <div class="col-span-12">
                        <div class="flex items-start space-x-2 rtl:space-x-reverse">
                            ...
                            <span class="text-sm text-gray-500 dark:text-zinc-300">You are Register as a {{$AccountType}} </span>
                        </div>
                    </div>
...
{{-- Check if user_type is 'client' and account_type is 'buyer' --}}
@if ($user_type === 'client' && $account_type === 'buyer')
    {{-- Company Name --}}
    <div class="col-span-12 mt-4">
        <label for="company_name" class="block text-gray-700 text-sm font-medium mb-2">Company Name</label>
        <div class="relative w-full shadow-sm rounded-md">
            {{-- Input --}}
            <input type="text" name="company_name" id="company_name" class="{{ $errors->first('company_name') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300' }} border text-gray-900 text-sm rounded-md font-medium block w-full ltr:pr-12 rtl:pl-12 p-4 placeholder:font-normal dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter Company Name">
        </div>
        {{-- Error --}}
        @error('company_name')
            <p class="mt-1.5 text-[13px] tracking-wide text-red-600 font-medium ltr:pl-1 rtl:pr-1">
    ...
    {{-- Company Logo --}}
    <div class="col-span-12 mt-4">
        <label for="company_logo" class="block text-gray-700 text-sm font-medium mb-2">Company Logo</label>
        <div class="relative w-full shadow-sm rounded-md">
            {{-- Input --}}
            <input type="file" name="company_logo" id="company_logo" class="{{ $errors->first('company_logo') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300' }} border text-gray-900 text-sm rounded-md font-medium block w-full ltr:pr-12 rtl:pl-12 p-4 placeholder:font-normal dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Upload Company Logo">
        </div>
        {{-- Error --}}
        @error('company_logo')
            <p class="mt-1.5 text-[13px] tracking-wide text-red-600 font-medium ltr:pl-1 rtl:pr-1">
    ...
    {{-- SSM Document --}}
    <div class="col-span-12 mt-4">
        <label for="ssm_document" class="block text-gray-700 text-sm font-medium mb-2">SSM Document</label>
        <div class="relative w-full shadow-sm rounded-md">
            {{-- Input --}}
            <input type="file" name="ssm_document" id="ssm_document" class="{{ $errors->first('ssm_document') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300' }} border text-gray-900 text-sm rounded-md font-medium block w-full ltr:pr-12 rtl:pl-12 p-4 placeholder:font-normal dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Upload SSM Document">
        </div>
        {{-- Error --}}
        @error('ssm_document')
            <p class="mt-1.5 text-[13px] tracking-wide text-red-600 font-medium ltr:pl-1 rtl:pr-1">
...
<!--- tonmoy --->
					...
					{{-- Register --}}
					<div class="col-span-12 mt-3 mb-3 text-center">
						...
						<!--<button type="submit" wire:loading.attr="disabled" wire:target="register" :disabled="!form.email || !form.password || !form.fullname || !form.username" class="w-full bg-primary-600 enabled:hover:bg-primary-700 text-white py-4.5 px-4 rounded-md text-[13px] font-semibold tracking-wide disabled:bg-zinc-200 disabled:text-zinc-500 dark:disabled:bg-zinc-500 dark:disabled:text-zinc-300 disabled:cursor-not-allowed font-medium">-->
						    ...
						    <button type="submit" wire:loading.attr="disabled" wire:target="register" :disabled="!form.email || !form.password || !form.fullname || !form.username" class="lets_button bg-yellow-300 text-black py-2 px-5 text-base font-medium">
