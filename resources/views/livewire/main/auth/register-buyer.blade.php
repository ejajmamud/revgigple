<div class="flex w-full grow flex-col justify-center p-5">

    <?php
    $route = "{{ url('auth/register') }}";
    if ($route === "{{ url('auth/register') }}") {
        $cssFiles = [
    ...
    <div style="display:none" class="text-center">
        <div class="mt-4">
            ...
            <a href="{{ url('/') }}"
               class="block lg:hidden mt-3 text-sm tracking-wider font-semibold text-blue-600 hover:underline">
    ...
    <div class="mt-8">
        ...
        <lable> Business Registration</lable>
        ...
        <div class="w-full relative">
            ...
            {{-- Register form --}}
            <div class="mt-6">
                <form x-data="window.UcZWcDFfVKBjfgP" x-on:submit.prevent="register"
                      class="grid grid-cols-12 md:gap-x-6 gap-y-6">
                    ...
                    <div class="col-span-12">
                        <div class="relative w-full shadow-sm rounded-md">
                            ...
                            <input type="text" x-model="form.fullname"
                                   class="{{ $errors->first('fullname') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300' }} border text-gray-900 text-sm rounded-md font-medium block w-full ltr:pr-12 rtl:pl-12 p-4 placeholder:font-normal dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            ...
                            <div class="absolute inset-y-0 ltr:right-0 rtl:left-0 flex items-center ltr:pr-3 rtl:pl-3">
                                <svg class="w-5 h-5 text-gray-400" stroke="currentColor" fill="currentColor"
                    ...
                    <div class="col-span-12">
                        <div class="relative w-full shadow-sm rounded-md">
                            <label  class="block text-gray-700 text-sm font-medium mb-2">User Name</label>
                            {{-- Input --}}
                            <input type="text" x-model="form.username"
                                   class="{{ $errors->first('username') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300' }} border text-gray-900 text-sm rounded-md font-medium block w-full ltr:pr-12 rtl:pl-12 p-4 placeholder:font-normal dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    ...
                    <div class="col-span-12">
                        <div class="relative w-full shadow-sm rounded-md">
                            ...
                            <input type="text" wire:model="companyname"
                                   class="{{ $errors->first('companyname') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300' }} border text-gray-900 text-sm rounded-md font-medium block w-full ltr:pr-12 rtl:pl-12 p-4 placeholder:font-normal dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    ...
                    {{-- Company Logo --}}
                    <div class="col-span-12">
                        <label for="company_logo" class="block text-gray-700 text-sm font-medium mb-2">Company
                            Logo</label>
                        <div class="relative w-full shadow-sm rounded-md">
                            {{-- Input --}}
                            ...
                            <input type="file" wire:model="company_logo" id="company_logo"
                                   class="{{ $errors->first('company_logo') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300' }} border text-gray-900 text-sm rounded-md font-medium block w-full ltr:pr-12 rtl:pl-12 p-4 placeholder:font-normal dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    ...
                    {{-- SSM Document --}}
                    <div class="col-span-12">
                        <label for="ssm_document" class="block text-gray-700 text-sm font-medium mb-2">SSM
                            Document</label>
                        <div class="relative w-full shadow-sm rounded-md">
                            {{-- Input --}}
                            <input type="file" wire:model="ssm_document" id="ssm_document"
                                   class="{{ $errors->first('ssm_document') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300' }} border text-gray-900 text-sm rounded-md font-medium block w-full ltr:pr-12 rtl:pl-12 p-4 placeholder:font-normal dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                   placeholder="Upload SSM Document" required>
                        </div>
                        {{-- Error --}}
                        @error('ssm_document')
                        <p class="mt-1.5 text-[13px] tracking-wide text-red-600 font-medium ltr:pl-1 rtl:pr-1">
                            {{ $errors->first('ssm_document') }}
                        </p>
                        @enderror
                    </div>
                    ...
                    <div class="col-span-12">
                        <div class="flex items-start space-x-2 rtl:space-x-reverse">
                            <svg class="w-6 h-6 text-gray-400 flex-shrink-0" stroke="currentColor" fill="currentColor"
                                 stroke-width="0" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                      d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                      clip-rule="evenodd"></path>
                            ...
                            <span
                                class="text-sm text-gray-500 dark:text-zinc-300">@lang('messages.t_by_signup_u_agree_to_terms_privacy')</span>
                        </div>
                    </div>
                    ...
                    {{--                    <div class="col-span-12">--}}
                    {{--                        <div class="flex items-start space-x-2 rtl:space-x-reverse bg-primary-700">--}}
                    {{--                            <button wire:click="changeAccountType" class="text-sm text-gray-500 dark:text-zinc-300">--}}
                    {{--                                You are  Register as a {{$AccountType}}--}}
                    {{--                            </button>--}}
                    {{--                        </div>--}}
                    {{--                    </div>--}}
                    ...
                    <div class="col-span-12 button_area flex-row-reverse">


                        <button style="font-size:12px !important; display:none" type="submit"
                                wire:loading.attr="disabled" wire:target="register"
                                :disabled="!form.email || !form.password || !form.fullname || !form.username"
                                class="button enabled:hover:bg-primary-700 text-white py-4.5 px-4 rounded-md text-[13px] font-semibold tracking-wide disabled:bg-zinc-200 disabled:text-zinc-500 dark:disabled:bg-zinc-500 dark:disabled:text-zinc-300 disabled:cursor-not-allowed">
                            GET STARTED
                        </button>
                        <div class="line"></div>
                        ...
                        <button type="submit" wire:loading.attr="disabled" wire:target="register"
                                :disabled="!form.email || !form.password || !form.fullname || !form.username"
                                class="lets_button bg-yellow-300 text-black py-2 px-5 text-base font-medium">
                    ...
                    @if (settings('auth')->is_facebook_login)
                        <div>
                            <a href="{{ url('auth/facebook') }}"
                               class="w-full inline-flex justify-center py-3 rounded-sm bg-zinc-200 hover:bg-[#eeeded] dark:bg-zinc-700 dark:hover:bg-zinc-600 text-sm font-medium">
            ...
            <div class="mt-6">
                <ul class="list-disc list-inside text-slate-500 text-[13px] space-y-2 dark:text-gray-300">
                    ...
                    <!--                           <a href="#" class="button login_btn">LOGIN</a>-->
                    <!--                           <div class="line"></div>-->
                    <!--                       </div>-->
                    ...
                    <li>
                        ...
                        <a class="hover:text-slate-600 dark:hover:text-zinc-100 hover:underline"
                           href="{{ url('auth/login-business') }}">
                            @lang('messages.t_already_have_account')
                        </a>
                    </li>
                    ...
                    @if (settings('footer')->privacy && settings('footer')->terms)
                        ...
                        <li>
                            <a class="hover:text-slate-600 dark:hover:text-zinc-100 hover:underline"
                               href="{{ url('page', settings('footer')->privacy->slug) }}">{{ settings('footer')->privacy->title }}</a>
                        </li>

                        {{-- Terms --}}
                        <li>
                            <a class="hover:text-slate-600 dark:hover:text-zinc-100 hover:underline"
                               href="{{ url('page', settings('footer')->terms->slug) }}">{{ settings('footer')->terms->title }}</a>
                        </li>
                    @endif
    ...
    {{--    <div class="col-span-12">--}}
    {{--        <div class="flex items-start space-x-2 rtl:space-x-reverse bg-blue-700">--}}
    {{--            <button wire:click="changeAccountType" class="text-sm text-gray-500 dark:text-zinc-300">--}}
    {{--                You are Register in as a {{$AccountType}}--}}
    {{--            </button>--}}
    {{--        </div>--}}
    {{--    </div>--}}
...
<main style="display:none">
    <div class="login_area">
        <img src="img/bg-shap.png" alt="" class="loging_shapper">
        <div class="container">
            <div class="loging_wrapper">
                ...
                <form action="#">
                    ...
                    <div class="input_group">
                        ...
                        <input type="password">
                        <button type="button" class="toggler"><i class="fas fa-eye"></i></button>
                    </div>
                    <div class="input_group">
                    ...
                    <div class="input_group">
                        <label class="block">CAPTCHA<span>*</span></label>
                        <img class="sign_img" src="img/robot.png" alt="not-found">
                    </div>
                    <div class="form-group">
                        <input type="checkbox" id="html">
                        <label for="html">*Yes, I understand and agree to Gigple Terms & Conditions and Privacy
                            Policy</label>
                    </div>
                    <div class="button_area">
...
if (window.location.href === "{{ url('auth/register') }}") {
  ...
  cssFiles.forEach(function(cssFile) {
    ...
    <!---<script>
      ...
      function togglePasswordVisibility() {
        ...
        const icon = document.querySelector('.absolute.inset-y-0.ltr\\:right-0.rtl\\:left-0.flex.items-center.ltr\\:pr-3.rtl\\:pl-3');
        ...
        if (input.type === 'password') {
          ...
          icon.innerHTML = `
            ...
            >
              ...
              <path
                fill-rule="evenodd"
                d="M10 3C5.03 3 1 7.03 1 12a9 9 0 0018 0c0-4.97-4.03-9-9-9zm0 16c-4.97 0-9-4.03-9-9a9 9 0 0118 0c0 4.97-4.03 9-9 9zm1-9a1 1 0 10-2 0v2a1 1 0 102 0v-2z"
                clip-rule="evenodd"
              ></path>
            </svg>
          `;
    ...
    // // Get the value of the 'account_type' parameter
    // const accountType = urlParams.get('user_type');

    // // Use the value of 'accountType' as needed
    // console.log(accountType); // Output: 'hire' (if the parameter is present in the URL)

    // </script>--->

@endpush

<!--<script src="{{ asset('/public/js/new-js/jquery-3.4.1.min.js') }}"></script>-->
<!--       <script src="{{ asset('/public/js/new-js/plugins.js') }}"></script>-->
<!--       <script src="{{ asset('/public/js/new-js/main.js') }}"></script>-->
