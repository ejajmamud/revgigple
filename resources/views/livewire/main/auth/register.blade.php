...
<label> Giggers Registration</label>
                ...
                <form x-data="window.UcZWcDFfVKBjfgP" x-on:submit.prevent="register" class="grid grid-cols-12 md:gap-x-6 gap-y-6">
                    ...
                    <div class="col-span-12">
                        <div class="relative w-full shadow-sm rounded-md">
                            ...
                            {{-- Icon --}}
                            <div class="absolute inset-y-0 ltr:right-0 rtl:left-0 flex items-center ltr:pr-3 rtl:pl-3" onclick="togglePasswordVisibility()">
            ...
            <div class="loging_wrapper">
                ...
                <form action="#">
                    ...
                    <div class="form-group">
                        ...
                        <label for="html">*Yes, I understand and agree to Gigple Terms & Conditions and Privacy Policy</label>
                    </div>
                    <div class="button_area">
