<style>
    ...
    .button:hover {
        ...
        border-right: 1px solid #26c0ec !important;

        border-bottom: 1px solid #26c0ec !important;
    }
</style>
...
<div class="container" style="display:block">
    ...
    <div class="mt-8">
        ...
        <div class="w-full relative">
            <!--<h6 class="text-center">You are login as Buyer</h6>-->
            {{-- Login form --}}
            <div class="mt-6">
                <form x-data="window.zyKtAkZuKbBmbfC" x-on:submit.prevent="login"
                      class="grid grid-cols-12 md:gap-x-6 gap-y-6">

                    {{-- E-mail address --}}
                    <div class="col-span-12">

                        <label class="text-xl leading-1.2 tracking-tighter text-black font-semibold pb-3 uppercase">EMAIL
                            ADDRESS</label>
                        <div class="relative w-full shadow-sm rounded-md">
                            ...
                            <input type="email" x-model="form.email"
                                   ...
                                   style="background:white; border: 1px solid black !important;">
                    ...
                    <div class="col-span-12">
                        <div class="relative w-full shadow-sm rounded-md">
                            ...
                            <label class="text-xl leading-1.2 tracking-tighter text-black font-semibold pb-3 uppercase">password</label>
                        ...
                        <div class="relative flex items-start">
                            ...
                            <div class="ltr:ml-3 rtl:mr-3 text-[13px]">
                                <label for="remember_me"
                                       class="font-normal text-zinc-600 dark:text-gray-400 cursor-pointer">{{ __('messages.t_remember_me') }}</label>
                            </div>
                        </div>
                    </div>
                    ...
                    @if (settings('security')->is_recaptcha)
                        <div class="col-span-12 " wire:ignore>
                            <div style="width:50% !important" class="g-recaptcha"
                    ...
                    <div style="display:none" class="button_area">
...
" type="submit" wire:loading.attr="disabled" wire:target="login" :disabled="!form.email || !form.password"
                                class="button login_btn">LOGIN
                        </button>
                        <div class="line">
                    ...
                    <div class="col-span-12 text-center" style="margin-right: 10px;
">


                        <!--<button  style="font-size:12px !important; display:none" type="submit" wire:loading.attr="disabled" wire:target="register" :disabled="!form.email || !form.password || !form.fullname || !form.username" class="button enabled:hover:bg-primary-700 text-white py-4.5 px-4 rounded-md text-[13px] font-semibold tracking-wide disabled:bg-zinc-200 disabled:text-zinc-500 dark:disabled:bg-zinc-500 dark:disabled:text-zinc-300 disabled:cursor-not-allowed">GET STARTED</button>-->


                        <button style="font-size: 1.5rem !important; line-height: 1.2 !important;  padding: 0.3rem 1.4rem !important;
...
" type="submit" wire:loading.attr="disabled" wire:target="login" :disabled="!form.email || !form.password"
                    ...
                    <div class="col-span-12">
                        ...
                        <button style="display:none !important" class="button" type="submit"
                                wire:loading.attr="disabled" wire:target="login"
                                :disabled="!form.email || !form.password"
                                class="inline-block text-black bg-sky-500 py-2 px-5 leading-normal font-normal border-b-2 border-r-2 enabled:hover:bg-black  enabled:hover:text-white py-4.5 px-4 rounded-md text-[13px] font-semibold tracking-wide disabled:cursor-not-allowed"
                                style="display: inline-block; font-size: 1.6rem; line-height: 1.2; color: #000; background-color: var(--sky); padding: 0.5rem 1.4rem; letter-spacing: 0.2rem; font-weight: 400; border: none; border-bottom: 0.2rem solid #000 !important; border-right: 0.2rem solid #000 !important;">


                            <!--class="inline-block text-black bg-sky-500 py-2 px-5 leading-normal font-normal border-b-2 border-r-2'-->
            ...
            <div class="mt-6 pb-5">
                <ul class="list-disc list-inside text-slate-500 text-[13px] space-y-2 dark:text-gray-300">
                    ...
                    <div class="register_area">
                        <h5><a href="{{ url('lets-started') }}">Don’t have an account?</a></h5>
    ...
    padding: 0.2rem 0.4rem !important;" href="{{ url('lets-started') }}" class="button">GET STARTED</a>
                            <div class="line"></div>
                        </div>
                    </div>
                    ...
                    <li style="display:none">
                        <!--<a class="hover:text-slate-600 dark:hover:text-zinc-100 hover:underline"  style="display: inline-block; font-size: 1.6rem; line-height: 1.2; color: #000; background-color: var(--sky); padding: 0.5rem 1.4rem; letter-spacing: 0.2rem; font-weight: 400; border: none; border-bottom: 0.2rem solid #000 !important; border-right: 0.2rem solid #000 !important;" href="{{ url('auth/register') }}">-->
                        <!--	@lang('messages.t_create_account')    -->
                        <!--</a>-->


                        <a class="button hover:text-slate-600 dark:hover:text-zinc-100 hover:underline"
                           style="display: inline-block; font-size: 1.6rem; line-height: 1.2; color: #000; background-color: var(--sky); padding: 0.5rem 1.4rem; letter-spacing: 0.2rem; font-weight: 400; border: none; border-bottom: 0.2rem solid #000 !important; border-right: 0.2rem solid #000 !important;"
...
<link href="{{ asset('/public/css/new-css/bootstrap.min.css') }}" rel="stylesheet" type="text/css"/>
<link href="{{ asset('/public/css/new-css/fontawesome.min.css') }}" rel="stylesheet" type="text/css"/>
<link href="{{ asset('/public/css/new-css/owl.carousel.min.css') }}" rel="stylesheet" type="text/css"/>
<link href="{{ asset('/public/css/new-css/magnific-popup.css') }}" rel="stylesheet" type="text/css"/>
<link href="{{ asset('/public/css/new-css/helper.css') }}" rel="stylesheet" type="text/css"/>
<link href="{{ asset('/public/css/new-css/style.css') }}" rel="stylesheet" type="text/css"/>
<link href="{{ asset('/public/css/new-css/responsive.css') }}" rel="stylesheet" type="text/css"/>
            ...
            <form x-data="window.zyKtAkZuKbBmbfC" x-on:submit.prevent="login">
                ...
                <div class="button_area">
                    <button type="submit" wire:loading.attr="disabled" wire:target="login"
                            :disabled="!form.email || !form.password" href="#" class="button login_btn">LOGIN
                    </button>
...
// if (window.location.href === "{{ url('auth/login') }}") {
...
//     // Get the div element
// const div = document.getElementById('rc-anchor-container');

// // Add Tailwind CSS classes to the div
// div.classList.add('w-full', 'md:w-60');

// // Add an event listener to adjust the div width and text size on window resize
// window.addEventListener('resize', () => {
//   // Get the current device width
//   const deviceWidth = window.innerWidth;

//   // Check if the device width is between 25px and 440px
//   if (deviceWidth >= 25 && deviceWidth <= 440) {
//     // Set the div width to 60%
//     div.classList.add('w-60');

//     // Adjust the text size based on the div width
//     const divWidth = div.offsetWidth;
//     const textSize = (divWidth / 100) * 1.5; // Adjust the text size based on the div width and a scaling factor

//     // Set the text size for all text elements inside the div
//     const textElements = div.querySelectorAll('span, label, a');
//     textElements.forEach((element) => {
//       element.style.fontSize = `${textSize}px`;
//     });
//   } else {
//     // Remove the div width and text size classes if the device width is outside the range
//     div.classList.remove('w-60');

//     // Reset the text size for all text elements inside the div
//     const textElements = div.querySelectorAll('span, label, a');
//     textElements.forEach((element) => {
...
<script>
    ...
    // document.getElementById("buyer-link").href = "https://rev.gigple.com/auth/login-buyer";

    // document.getElementById("freelancer-link").href = "https://rev.gigple.com/auth/login";
