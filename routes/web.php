...
//lets stared
    Route::namespace('LetStarted')->group(function() {
        ...
        Route::get('lets-started', LetStartedComponent::class);
    ...
    // GigsComponent
        ...
        Route::namespace('Gigs')->group(function() {

        Route::get('business-gigs', GigsComponent::class);
  ...
  //About fayjur
    ...
    //Gigger fayjur
    Route::namespace('Gigger')->group(function() {

        Route::get('giggers', GiggersComponent::class);
...
//     fayjur
    ...
    //anamerasul
        ...
        Route::get('business', BusinessComponent::class);

    });
    
      Route::namespace('GenerativeAI')->group(function() {

        Route::get('generativeai', GenerativeAI::class);
        ...
        Route::get('slider', Slider::class);
         ...
         Route::namespace('BusinessLogin')->group(function() {

         Route::get('business/login',  BusinessLogin::class);

    });
    
    
          Route::namespace('BusinessRegister')->group(function() {

         Route::get('business/signup',   BusinessRegister::class);
    ...
    Route::namespace('BusinessDashboard')->group(function() {

         Route::get('business/dashshboard',  BusinessDashboard::class);
    ...
    Route::namespace('BusinessDashboard')->group(function() {
         ...
         Route::get('business/alumni',  Alumni::class);
       ...
       Route::namespace('BusinessDashboard')->group(function() {
         ...
         Route::get('business/gigple',  Gigple::class);
      ...
      Route::namespace('BusinessDashboard')->group(function() {
         ...
         Route::get('business/long-term',  Longterm::class);
      ...
      Route::namespace('BusinessDashboard')->group(function() {
         ...
         Route::get('business/probation',  Probation::class);
    ...
    Route::namespace('BusinessDashboard')->group(function() {
        ...
        Route::get('business/notifications',  Notifications::class);
    ...
    Route::namespace('Auth')->middleware('guest')->prefix('auth')->group(function() {
         ...
         Route::get('my-business-login',  MyBusinessLogin::class);
        ...
        // Register
        //  Route::get('register-old', RegisterComponentNew::class);

        // Login
        // Route::get('login-old', LoginComponentNew::class)->name('login');
        ...
        // old modify route
        Route::get('register-consultant', RegisterComponent::class);
        Route::get('register-business', RegisterbuyerComponent::class);
 


        // Login
        Route::get('login-business',  LoginbuyerComponent::class)->name('login');
        
        Route::get('login-consultant', LoginComponent::class)->name('login');
