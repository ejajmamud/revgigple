...
class BusinessDashboard extends Component
{
    ...
    public function getCategorySkill($id){
        $skillName = ProjectSkill::select('name')->where('id', $id)->get();
        return $skillName;
    ...
    public function render()
    {
        ...
        if($this->searchItem){
             return view('livewire.main.business-dashboard.business-dashboard',
            [
                'projects'   => Project::where('user_id', Auth::id())->where('title', $this->searchItem)->latest()->paginate(10),
            ]
        ...
        // return view('livewire.main.business-dashboard.business-dashboard',
        // [
        //     'projects'   => Project::where('user_id', Auth::id())->latest()->paginate(30),
        // ]
        // )->extends('livewire.main.layout.app');
