...
class MyBusinessLogin extends Component
   ...
   use SEOToolsTrait, Actions; 
     ...
     public function render()
    {
        ...
        $this->seo()->jsonLd()->setType('WebSite');
          ...
          return view('livewire.main.business-login.business-login-one')->extends('livewire.main.layout.app');
    }
...
// Check if user is active, verified, has user_type as 'client', and account_type as 'buyer'
if ($user && in_array($user->status, ['active', 'verified']) && $user->user_type === 'client' && $user->account_type === 'buyer') {
    return redirect()->intended('business/dashshboard');
