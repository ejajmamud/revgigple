...
use App\Http\Livewire\Main\LetStarted\LetStartedComponent;
...
class RegisterbuyerComponent extends Component
{
    ...
    public function mount()
    {
        ...
        $this->userType = request()->query('user_type');
        
        $this->AccountType = request()->query('account_type');
    ...
    public function render()
    {
        ...
        return view('livewire.main.auth.register-buyer')->extends('livewire.main.auth.layout.auth')->section('content');
    }
    ...
    public function register($form)
    {
        ...
        try {
            ...
            $this->username        = $form['username'];
             ...
             $this->validate([
                    'company_logo' => 'image|max:5120', // 1MB Max
                    ]);
                
            $company_logo_name = $this->company_logo->store('avatars');
             ...
             $this->validate([
                    'ssm_document' => 'image|max:5120', // 1MB Max
                    ]);
                
            $ssm_document_name = $this->company_logo->store('ssm-document');
            ...
            $user->profile_img = str_replace("avatars/","",$company_logo_name);  
              
            $user->ssm_document = str_replace("ssm-document/","",$ssm_document_name);  
