...
class LoginbuyerComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.main.auth.login-buyer')->extends('livewire.main.auth.layout.auth')->section('content');
    }
    ...
    { 
        ...
        try {
            ...
            if (Auth::attempt($credentials, $this->remember_me)) {
                ...
                if ( in_array(auth()->user()->status, ['active', 'verified']) && in_array(auth()->user()->account_type, ['buyer'])) {
                    
                    // Go to home
                    // return redirect()->intended('/');
                    
                    return redirect()->to('/business/dashshboard');
