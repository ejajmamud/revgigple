...
{
    Auth::user()->update(['isAvatar' => true]);
    $this->isAvatar = true;
...
{
    Auth::user()->update(['isAvatar' => false]);
    $this->isAvatar = false;
...
public function showlogoutProfile()
{
    Auth::user()->update(['isguestAvatar' => true]);
    $this->isguestAvatar= true;
    
    
    $this->dispatchBrowserEvent('reload-page-two');
}

public function showlogoutAvatar()
{
    Auth::user()->update(['isguestAvatar' => false]);
    $this->isguestAvatar = false;
    ...
    public function mount()
    {
        ...
        // $this->isAvatar = auth()->user()->isAvatar;
        
        // $this->isAvatar = session('isAvatar', 'false');
        
    $user = auth()->user();
    $this->isAvatar = $user->isAvatar ?? session('isAvatar', true );
    
     $this->isguestAvatar = $user->isguestAvatar ?? session('isguestAvatar', true );
