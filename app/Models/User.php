...
{
    // Assuming 'isAvatar' is the name of the column in your users table
    return $this->attributes['isAvatar'];
}



public function getIsGuestAvatarAttribute()
{
    // Assuming 'isAvatar' is the name of the column in your users table
    return $this->attributes['isguestAvatar'];
}
    /**
